...
def create_dataloader(dataset_name, gt_type, img_size, 
    ...
    if dataset_name == "cycif":
        return create_cycif(gt_type, img_size, batch_size, recompute_dataset)
    elif dataset_name == "cytometry":
...
def create_cycif(gt_type, img_size, batch_size, recompute_dataset):
    ...
    channels_toExclude = ['A488', 'A555', 'A555_7', 'A647', 
                          'Hoechst2', 'Hoechst4', 'Hoechst5', 'Hoechst6',
    ...
    dataset_train = BioformatTiffreader(prepared_data, img_size=img_size,
                                        phase_str='train')
    dataset_test = BioformatTiffreader(prepared_data, img_size=img_size,
                                       phase_str='test')
    dataset_loader = dict()
